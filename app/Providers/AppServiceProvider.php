...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach (['users_and_roles', 'orders', 'pos', 'bookings', 'finance', 'members', 'leads', 'inventory', 'rewards', 'reports', 'master_services', 'master_work_shifts', 'master_timezone', 'master_app_settings', 'master_receipt'] as $moduleKey) {
