...
{
    /**
     * @return list<array{id: int, orderNo: string, invoice: string, time: string, customerId: int|null, customer: string, phone: string, vehicle: string, plate: string, items: string, serviceIds: list<int>, total: int, payment: string, paymentStatus: string, status: string, stampsEarned: int, crew: string, bay: string, source: string}>
     */
    public static function orders(): array
    {
        return [
            ['id' => 1, 'orderNo' => 'ORD-25080312', 'invoice' => 'ZW-25080312', 'time' => '11.02', 'customerId' => 10, 'customer' => 'Nadia Putri', 'phone' => '0896-1122-3344', 'vehicle' => 'Honda Vario', 'plate' => 'B 2255 LM', 'items' => 'Cuci Motor + Semir', 'serviceIds' => [5], 'total' => 35000, 'payment' => 'QRIS', 'paymentStatus' => 'lunas', 'status' => 'proses', 'stampsEarned' => 1, 'crew' => 'Bagas', 'bay' => 'Bay 3', 'source' => 'walk-in'],
            ['id' => 2, 'orderNo' => 'ORD-25080311', 'invoice' => 'ZW-25080311', 'time' => '10.40', 'customerId' => 8, 'customer' => 'Andi Wijaya', 'phone' => '0852-6677-8899', 'vehicle' => 'Yamaha NMax', 'plate' => 'B 6677 TG', 'items' => 'Cuci Motor Reguler', 'serviceIds' => [4], 'total' => 20000, 'payment' => 'Tunai', 'paymentStatus' => 'lunas', 'status' => 'menunggu', 'stampsEarned' => 1, 'crew' => 'Menunggu crew', 'bay' => '—', 'source' => 'walk-in'],
            ['id' => 3, 'orderNo' => 'ORD-25080310', 'invoice' => 'ZW-25080310', 'time' => '10.15', 'customerId' => 4, 'customer' => 'Maya Kusuma', 'phone' => '0857-2210-8890', 'vehicle' => 'Mitsubishi Xpander', 'plate' => 'B 4412 ZX', 'items' => 'Deep Clean Interior, Parfum & Anti Jamur Kaca', 'serviceIds' => [9, 11], 'total' => 210000, 'payment' => 'Debit', 'paymentStatus' => 'lunas', 'status' => 'proses', 'stampsEarned' => 2, 'crew' => 'Tim Interior', 'bay' => 'Bay 4', 'source' => 'booking'],
            ['id' => 4, 'orderNo' => 'ORD-25080309', 'invoice' => 'ZW-25080309', 'time' => '09.52', 'customerId' => null, 'customer' => 'Umum (non-member)', 'phone' => '—', 'vehicle' => 'Toyota Calya', 'plate' => 'B 1290 UY', 'items' => 'Cuci Mobil Reguler', 'serviceIds' => [1], 'total' => 45000, 'payment' => 'Tunai', 'paymentStatus' => 'lunas', 'status' => 'selesai', 'stampsEarned' => 0, 'crew' => 'Agus', 'bay' => 'Bay 1', 'source' => 'walk-in'],
            ['id' => 5, 'orderNo' => 'ORD-25080308', 'invoice' => 'ZW-25080308', 'time' => '09.20', 'customerId' => 1, 'customer' => 'Hendra Gunawan', 'phone' => '0812-1100-2255', 'vehicle' => 'Mazda CX-5', 'plate' => 'B 5150 AB', 'items' => 'Nano Ceramic Coating', 'serviceIds' => [7], 'total' => 1500000, 'payment' => 'Transfer', 'paymentStatus' => 'lunas', 'status' => 'proses', 'stampsEarned' => 10, 'crew' => 'Tim Detailing', 'bay' => 'Bay 1', 'source' => 'booking'],
            ['id' => 6, 'orderNo' => 'ORD-25080307', 'invoice' => 'ZW-25080307', 'time' => '08.45', 'customerId' => 5, 'customer' => 'Siti Rahmawati', 'phone' => '0821-4455-6677', 'vehicle' => 'Honda Brio', 'plate' => 'B 8821 KL', 'items' => 'Cuci Mobil Reguler, Semir Ban Premium', 'serviceIds' => [1, 12], 'total' => 70000, 'payment' => 'QRIS', 'paymentStatus' => 'lunas', 'status' => 'selesai', 'stampsEarned' => 1, 'crew' => 'Agus', 'bay' => 'Bay 2', 'source' => 'walk-in'],
            ['id' => 7, 'orderNo' => 'ORD-25080306', 'invoice' => 'ZW-25080306', 'time' => '08.05', 'customerId' => 2, 'customer' => 'Rizky Pratama', 'phone' => '0813-7788-1200', 'vehicle' => 'Honda Civic', 'plate' => 'B 9090 RS', 'items' => 'Snow Wash Premium, Engine Bay Cleaning', 'serviceIds' => [3, 8], 'total' => 210000, 'payment' => 'QRIS', 'paymentStatus' => 'lunas', 'status' => 'proses', 'stampsEarned' => 3, 'crew' => 'Agus & Deni', 'bay' => 'Bay 2', 'source' => 'walk-in'],
            ['id' => 8, 'orderNo' => 'ORD-25080305', 'invoice' => 'ZW-25080305', 'time' => '07.48', 'customerId' => null, 'customer' => 'Umum (non-member)', 'phone' => '—', 'vehicle' => 'Suzuki XL7', 'plate' => 'B 7742 KD', 'items' => 'Cuci Mobil + Wax', 'serviceIds' => [2], 'total' => 85000, 'payment' => 'Tunai', 'paymentStatus' => 'lunas', 'status' => 'selesai', 'stampsEarned' => 0, 'crew' => 'Deni', 'bay' => 'Bay 3', 'source' => 'walk-in'],
            ['id' => 9, 'orderNo' => 'ORD-25080304', 'invoice' => '—', 'time' => '07.30', 'customerId' => 9, 'customer' => 'Dewi Lestari', 'phone' => '0813-2233-5566', 'vehicle' => 'Daihatsu Ayla', 'plate' => 'B 3311 QW', 'items' => 'Cuci Mobil Reguler', 'serviceIds' => [1], 'total' => 45000, 'payment' => '—', 'paymentStatus' => 'belum bayar', 'status' => 'selesai', 'stampsEarned' => 1, 'crew' => 'Bagas', 'bay' => 'Bay 3', 'source' => 'walk-in'],
            ['id' => 10, 'orderNo' => 'ORD-25080303', 'invoice' => '—', 'time' => '07.15', 'customerId' => 3, 'customer' => 'Budi Santoso', 'phone' => '0812-3456-7890', 'vehicle' => 'Toyota Avanza', 'plate' => 'B 1234 CDE', 'items' => 'Cuci Mobil + Wax', 'serviceIds' => [2], 'total' => 85000, 'payment' => '—', 'paymentStatus' => 'belum bayar', 'status' => 'menunggu', 'crew' => 'Menunggu crew', 'stampsEarned' => 1, 'bay' => '—', 'source' => 'booking'],
        ];
    }
