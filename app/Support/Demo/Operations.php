...
class Operations
{
     ...
     *
     * @return list<array{id: int, code: string, customerId: int|null, customer: string, phone: string, vehicle: string, plate: string, service: string, serviceIds: list<int>, date: string, bookingDate: string, bookingTime: string, orderStatus: string, estimate: int, notes: string}>
     */
     ...
     *
     * @return list<array{id: int, code: string, customerId: int|null, customer: string, phone: string, vehicle: string, plate: string, service: string, serviceIds: list<int>, date: string, bookingDate: string, bookingTime: string, estimate: int, notes: string}>
     */
    public static function bookings(): array
    {
        $bookings = [
            ['id' => 1, 'code' => self::bookingCode(0, 1), 'customerId' => 3, 'customer' => 'Budi Santoso', 'phone' => '0812-3456-7890', 'vehicle' => 'Toyota Avanza', 'plate' => 'B 1234 CDE', 'service' => 'Cuci Mobil + Wax', 'serviceIds' => [2], 'date' => self::date(0), 'bookingDate' => self::date(-1), 'bookingTime' => '16.40', 'estimate' => 85000, 'notes' => 'Minta lap ekstra di bagasi.'],
            ['id' => 2, 'code' => self::bookingCode(0, 2), 'customerId' => 1, 'customer' => 'Hendra Gunawan', 'phone' => '0812-1100-2255', 'vehicle' => 'Mazda CX-5', 'plate' => 'B 5150 AB', 'service' => 'Nano Ceramic Coating', 'serviceIds' => [7], 'date' => self::date(0), 'bookingDate' => self::date(0), 'bookingTime' => '08.05', 'estimate' => 1500000, 'notes' => 'Pembayaran sebagian 50% via transfer.'],
            ['id' => 3, 'code' => self::bookingCode(0, 3), 'customerId' => 4, 'customer' => 'Maya Kusuma', 'phone' => '0857-2210-8890', 'vehicle' => 'Mitsubishi Xpander', 'plate' => 'B 4412 ZX', 'service' => 'Deep Clean Interior', 'serviceIds' => [9], 'date' => self::date(0), 'bookingDate' => self::date(0), 'bookingTime' => '09.20', 'estimate' => 150000, 'notes' => 'Ada noda kopi di karpet depan.'],
            ['id' => 4, 'code' => self::bookingCode(0, 4), 'customerId' => 7, 'customer' => 'Clara Halim', 'phone' => '0811-3030-4040', 'vehicle' => 'Suzuki Ertiga', 'plate' => 'B 1717 PO', 'service' => 'Snow Wash Premium', 'serviceIds' => [3], 'date' => self::date(0), 'bookingDate' => self::date(-1), 'bookingTime' => '15.10', 'estimate' => 120000, 'notes' => '—'],
            ['id' => 5, 'code' => self::bookingCode(1, 1), 'customerId' => 2, 'customer' => 'Rizky Pratama', 'phone' => '0813-7788-1200', 'vehicle' => 'Honda Civic', 'plate' => 'B 9090 RS', 'service' => 'Poles Body Detailing', 'serviceIds' => [6], 'date' => self::date(1), 'bookingDate' => self::date(0), 'bookingTime' => '10.35', 'estimate' => 450000, 'notes' => 'Baret halus di pintu kanan.'],
            ['id' => 6, 'code' => self::bookingCode(1, 2), 'customerId' => 5, 'customer' => 'Siti Rahmawati', 'phone' => '0821-4455-6677', 'vehicle' => 'Honda Brio', 'plate' => 'B 8821 KL', 'service' => 'Salon Jok & Karpet', 'serviceIds' => [10], 'date' => self::date(1), 'bookingDate' => self::date(-1), 'bookingTime' => '17.25', 'estimate' => 350000, 'notes' => '—'],
            ['id' => 7, 'code' => self::bookingCode(2, 1), 'customerId' => 6, 'customer' => 'Fajar Nugroho', 'phone' => '0878-9012-3344', 'vehicle' => 'Toyota Fortuner', 'plate' => 'B 7788 JK', 'service' => 'Cuci Mobil + Wax', 'serviceIds' => [2], 'date' => self::date(2), 'bookingDate' => self::date(0), 'bookingTime' => '11.50', 'estimate' => 85000, 'notes' => '—'],
            ['id' => 8, 'code' => self::bookingCode(-1, 7), 'customerId' => 9, 'customer' => 'Dewi Lestari', 'phone' => '0813-2233-5566', 'vehicle' => 'Daihatsu Ayla', 'plate' => 'B 3311 QW', 'service' => 'Cuci Mobil Reguler', 'serviceIds' => [1], 'date' => self::date(-1), 'bookingDate' => self::date(-1), 'bookingTime' => '07.45', 'estimate' => 45000, 'notes' => '—'],
            ['id' => 9, 'code' => self::bookingCode(-1, 6), 'customerId' => 11, 'customer' => 'Gilang Ramadhan', 'phone' => '0817-8899-1010', 'vehicle' => 'Wuling Almaz', 'plate' => 'B 9021 HH', 'service' => 'Snow Wash Premium', 'serviceIds' => [3], 'date' => self::date(-1), 'bookingDate' => self::date(-2), 'bookingTime' => '13.15', 'estimate' => 120000, 'notes' => 'Pelanggan membatalkan via WhatsApp.'],
        ];
