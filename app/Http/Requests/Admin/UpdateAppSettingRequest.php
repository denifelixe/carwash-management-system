...
class UpdateAppSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'app_photo' => ['nullable', File::image()->types(['jpg', 'jpeg', 'png', 'webp'])->max(20480)],
            'favicon' => [
                'nullable',
                File::types(['ico'])->max(20480),
            ],
            'favicon_16' => [
                'nullable',
                File::image()->types(['png'])->dimensions(Rule::dimensions()->width(16)->height(16))->max(20480),
            ],
            'favicon_32' => [
                'nullable',
                File::image()->types(['png'])->dimensions(Rule::dimensions()->width(32)->height(32))->max(20480),
            ],
            'apple_touch_icon' => [
                'nullable',
                File::image()->types(['png'])->dimensions(Rule::dimensions()->width(180)->height(180))->max(20480),
            ],
            'android_chrome_192' => [
                'nullable',
                File::image()->types(['png'])->dimensions(Rule::dimensions()->width(192)->height(192))->max(20480),
            ],
            'android_chrome_512' => [
                'nullable',
                File::image()->types(['png'])->dimensions(Rule::dimensions()->width(512)->height(512))->max(20480),
            ],
            'site_webmanifest' => ['nullable', File::types(['webmanifest', 'json'])->max(20480)],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'meta_image.max' => 'Ukuran social image maksimal 20 MB.',
            ...
            'app_photo.max' => 'Ukuran foto aplikasi maksimal 20 MB.',
            'favicon.mimes' => 'Favicon utama harus berupa file ICO.',
            'favicon.max' => 'Ukuran favicon utama maksimal 20 MB.',
            ...
            'favicon_16.max' => 'Ukuran favicon 16x16 maksimal 20 MB.',
            ...
            'favicon_32.max' => 'Ukuran favicon 32x32 maksimal 20 MB.',
            ...
            'apple_touch_icon.max' => 'Ukuran apple touch icon maksimal 20 MB.',
            ...
            'android_chrome_192.max' => 'Ukuran Android Chrome 192 maksimal 20 MB.',
            ...
            'android_chrome_512.max' => 'Ukuran Android Chrome 512 maksimal 20 MB.',
            'site_webmanifest.mimes' => 'Site webmanifest harus berupa file JSON atau WEBMANIFEST.',
            'site_webmanifest.max' => 'Ukuran site webmanifest maksimal 20 MB.',
        ];
    }
