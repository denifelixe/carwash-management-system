...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('admin_modules')->upsert([
            ['key' => 'master_timezone', 'name' => 'Timezone', 'description' => 'Zona waktu operasional', 'sort_order' => 13, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ], ['key'], ['name', 'description', 'sort_order', 'is_active', 'updated_at']);

        $moduleId = DB::table('admin_modules')->where('key', 'master_timezone')->value('id');
