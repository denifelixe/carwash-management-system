...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('admin_modules')->upsert([
            ['key' => 'master_work_shifts', 'name' => 'Shift', 'description' => 'Master jadwal kerja', 'sort_order' => 12, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ], ['key'], ['name', 'description', 'sort_order', 'is_active', 'updated_at']);

        $moduleId = DB::table('admin_modules')->where('key', 'master_work_shifts')->value('id');
