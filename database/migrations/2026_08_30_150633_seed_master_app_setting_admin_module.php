...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('admin_modules')->upsert([
            ['key' => 'master_app_settings', 'name' => 'App Setting', 'description' => 'Nama, foto, dan favicon aplikasi', 'sort_order' => 14, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ], ['key'], ['name', 'description', 'sort_order', 'is_active', 'updated_at']);

        $moduleId = DB::table('admin_modules')->where('key', 'master_app_settings')->value('id');
