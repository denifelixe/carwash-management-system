...
DashboardStats::forDate takes the day's moneyIn so the ledger is read once and both the cards and cashSummary come off it. 'Stempel Ditukar' comes from RewardQueries::redeemedOnDate(), the reward module's own read.
