...
RecordOrderPayment stamps order_transactions.shift_name with the cashier's shift name at write time. It is null when the admin has no shift_id, and that null means "no shift" — do not re-derive a shift from paid_at.
