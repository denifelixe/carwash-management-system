...
Route::name('demo.')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('reports/order.csv', [ReportController::class, 'exportOrders'])
            ->middleware('demo.module:reports')
        ...
        Route::get('reports/penjualan-harian.csv', [ReportController::class, 'exportDailySales'])
            ->middleware('demo.module:reports')
            ->name('reports.daily-sales.export');

        Route::get('reports/penjualan-layanan.csv', [ReportController::class, 'exportItemSales'])
            ->middleware('demo.module:reports')
            ->name('reports.item-sales.export');
