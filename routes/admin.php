...
Route::domain((string) config('domains.admin'))
    ...
    ->group(function (): void {
        ...
        Route::middleware('auth:admin')->group(function (): void {
            ...
            Route::post('stok', [InventoryController::class, 'store'])->name('inventory.store');
            Route::patch('stok/{stockItem}', [InventoryController::class, 'update'])->name('inventory.update');
            Route::patch('stok/{stockItem}/status', [InventoryController::class, 'updateStatus'])->name('inventory.status.update');
            ...
            Route::patch('reward/{reward}', [RewardController::class, 'update'])->name('rewards.update');
            Route::patch('reward/{reward}/status', [RewardController::class, 'updateStatus'])->name('rewards.status.update');
            Route::delete('reward/{reward}', [RewardController::class, 'destroy'])->name('rewards.destroy');
