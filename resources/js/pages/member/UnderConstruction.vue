...
<template>
    <Head :title="`${brand.name} — Portal Member segera hadir`" />

    <div
        class="grid min-h-svh place-items-center bg-background px-4 py-12 text-foreground"
    >
        <main class="w-full max-w-lg text-center">
            ...
            >
                <span
                    class="inline-flex size-12 items-center justify-center rounded-full bg-sky-50 text-sky-600 dark:bg-sky-950"
                >
                    <Construction class="size-6" />
                </span>

                <h1 class="mt-5 text-xl font-semibold">
                    Portal Member segera hadir
                </h1>

                <p class="mt-3 text-sm leading-relaxed text-muted-foreground">
                    Halaman ini sedang kami siapkan. Sementara itu, silakan
                    hubungi kami lewat WhatsApp atau Instagram untuk informasi
                    layanan, harga, dan jadwal operasional.
                </p>
